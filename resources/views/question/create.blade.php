                    ...
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            ...
                            <div class="col-4 text-right">
                                <a href="{{ route('quizzes.show',$quiz) }}" class="btn btn-sm btn-primary">{{ __('Back to Quiz') }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('questions.store') }}" autocomplete="off">
                            ...
                            <div class="pl-lg-4">
                                <div class="form-group{{ $errors->has('title') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="title" id="input-title" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('title') }}" value="{{ old('name') }}" required autofocus>
                                    @if ($errors->has('title'))
                                ...
                                <div class="form-group{{ $errors->has('answers') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="answers" id="input-answers" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('answers') }}" value="{{ old('name') }}" required autofocus>
                                ...
                                <div class="form-group{{ $errors->has('right_answer') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="right_answer" id="input-right_answer" class="form-control form-control-alternative{{ $errors->has('name') ? ' is-invalid' : '' }}" placeholder="{{ __('right answer') }}" value="{{ old('name') }}" required autofocus>
