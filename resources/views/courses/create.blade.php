...
@section('content')
    @include('users.partials.header', ['title' => __('Add Course')])
            ...
            <div class="col-xl-12 order-xl-1">
                <div class="card bg-secondary shadow">
                    ...
                    <div class="card-body">
                        ...
                        <form method="post" action="{{ route('courses.store') }}" enctype="multipart/form-data" autocomplete="off">  {{--{{ route('users.store') }}--}}
                            @csrf
                            ...
                            <div class="pl-lg-4">
                                ...
                                <div class="form-group{{ $errors->has('description') ? ' has-danger' : '' }}">
                                    ...
                                    <textarea name="description" id="description" cols="30" rows="10" class="form-control form-control-alternative{{ $errors->has('description') ? ' is-invalid' : '' }}" placeholder="{{ __('Description') }}" required></textarea>
                                ...
                                <div class="form-group{{ $errors->has('price') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number"  name="price" id="input-price" class="form-control form-control-alternative{{ $errors->has('link') ? ' is-invalid' : '' }}" placeholder="{{ __('price') }}" value="" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" name="image" id="input-image" class="form-control form-control-alternative" required>
                                </div>
