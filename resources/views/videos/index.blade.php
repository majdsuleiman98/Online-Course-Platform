                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link" href="{{ route('quizzes.index') }}">
                            <i class="fas fa-school fa-2x text-blue"></i> {{ __('Quizzes') }}
                        </a>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="card-header border-0">
                            <div class="row align-items-center">
                                ...
                                <div class="col-4 text-right">
                                    <a href="{{ route('videos.create') }}" class="btn btn-sm btn-primary"><i class="fa-solid fa-circle-plus"></i>Add video</a>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="table align-items-center table-flush">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="admin/courses/{{ $video->course->id }}">{{ Str::limit($video->course->title) }}</a>
                                        </td>
