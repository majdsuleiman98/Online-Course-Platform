                    ...
                    <div class="card shadow">
                        ...
                        <form method="POST" action="{{route('tracks.update',$track)}}" autocomplete="off">
                            ...
                            <div class="row">
                                <div class="col-2"></div>
                                <div class="col-6">
                                    <input type="text" value="{{$track->name}}" name="name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                                </div>
                                <div class="col-4">
                                    <input type="submit" class="btn btn-sm btn-primary" value="Update Track" style="height: 46px; width: 100px;">
                                </div>
                            </div>
                        </form>
